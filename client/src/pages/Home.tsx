    ...
    <div className="min-h-screen bg-[#f4f1ea] text-[#133E2F] selection:bg-[#bca477] selection:text-[#133E2F]">
      ...
      <main id="top">
        ...
        <section id="catalogue" className="scroll-mt-20 bg-[#f4f1ea] px-5 py-20 lg:px-16 lg:py-28">
          <div className="mx-auto max-w-[1440px]">
            <div className="border-b border-[#133E2F]/15 pb-9">
            ...
            <div className="mt-16 flex justify-center"><Link href="/products" className="inline-flex items-center gap-3 bg-[#133E2F] px-6 py-4 text-[10px] uppercase tracking-[0.18em] text-white transition hover:bg-[#C5A059]">Explore the full range <ArrowRight size={14} /></Link></div>
          </div>
        </section>
