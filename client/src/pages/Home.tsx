...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f1ea] text-[#132F4F] selection:bg-[#bca477] selection:text-[#132F4F]">
      <SiteHeader />
      <main id="top">
        <section className="relative min-h-[760px] overflow-hidden bg-[#132F4F] pt-24 text-[#f9f7f1] lg:min-h-[820px]">
          ...
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(10,28,51,.95)_0%,rgba(10,28,51,.7)_42%,rgba(10,28,51,.12)_90%)]" />
          <div className="absolute inset-0 bg-[linear-gradient(0deg,rgba(10,28,51,.84)_0%,transparent_36%)]" />
          <div className="relative mx-auto flex min-h-[680px] max-w-[1440px] flex-col justify-center px-5 pb-20 lg:px-16">
            <div className="max-w-[660px]">
              ...
              <div className="mt-9 flex flex-wrap gap-3">
                <button onClick={() => scrollToSection("catalogue")} className="group inline-flex items-center gap-3 bg-[#C5A059] px-5 py-3.5 text-[10px] uppercase tracking-[0.18em] text-[#132F4F] transition hover:bg-[#f4e9cc]">Explore systems <ArrowRight size={14} className="transition group-hover:translate-x-1" /></button>
          ...
          <div className="absolute bottom-24 right-6 hidden w-[400px] gap-3 xl:flex 2xl:right-16">
            <Link href={`/products/${flagship.id}`} className="group relative h-[300px] flex-1 overflow-hidden border border-white/20 bg-[#1A3B63] text-left shadow-2xl shadow-[#0A1C33]/30">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#0A1C33]/90 via-[#0A1C33]/20 to-transparent" />
            ...
            <Link href={`/products/${featured.id}`} className="group relative mt-10 h-[260px] w-[150px] overflow-hidden border border-white/20 bg-[#1A3B63] text-left shadow-2xl shadow-[#0A1C33]/30">
