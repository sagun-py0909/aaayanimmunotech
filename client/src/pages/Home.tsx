          ...
          <div className="mx-auto max-w-[1440px]">
            ...
            <div className="mt-10 grid gap-10 lg:grid-cols-[220px_1fr] lg:items-start">
              <aside className="lg:sticky lg:top-28">
                <div className="flex items-center justify-between border-b border-[#1d1d1b]/15 pb-4"><div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.18em] text-[#24231f]"><SlidersHorizontal size={14} /> Refine</div><button onClick={resetFilters} className="text-[9px] uppercase tracking-[0.14em] text-[#9d8251]">Reset</button></div>
                ...
                <div className="py-5"><div className="mb-3 text-[9px] uppercase tracking-[0.18em] text-[#8a7657]">Price & supply guides</div><ul className="space-y-2 text-xs text-[#6f6a61]">{categories.map((category) => <li key={category.slug}><Link href={`/equipment/${category.slug}`} className="transition hover:text-[#24231f]">{category.label}</Link></li>)}</ul></div>
              </aside>
              <div>
        ...
        <section id="sectors" className="scroll-mt-20 bg-[#20201e] px-5 py-20 text-[#f6f1e8] lg:px-16 lg:py-28">
          <div className="mx-auto max-w-[1440px]">
            <div className="grid gap-12 lg:grid-cols-[.82fr_1.18fr] lg:items-end">
              <div><div className="mb-4 text-[10px] uppercase tracking-[0.28em] text-[#d5c59d]">Sectors / 02</div><h2 className="font-serif text-[clamp(2.8rem,5vw,5.5rem)] leading-[.9] tracking-[-0.04em]">One standard.<br /><em className="font-light text-[#d5c59d]">Five environments.</em></h2></div>
        ...
        <section id="supplier" className="scroll-mt-20 bg-[#e9e4da] px-5 py-20 lg:px-16 lg:py-28">
          <div className="mx-auto grid max-w-[1440px] gap-14 lg:grid-cols-[1.1fr_.9fr]">
            <div>
              ...
              <h2 className="font-serif text-[clamp(2.6rem,4.6vw,5rem)] leading-[.92] tracking-[-0.04em]">Hyperbaric, cryotherapy and <em className="font-light text-[#9d8251]">photobiomodulation</em> equipment.</h2>
